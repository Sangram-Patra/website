        ...
        <div className="container-fluid">
          <div className="row g-4 portfolio-grid">
            ...
            <div className="col-md-6 col-xl-6 portfolio-item category-1">
              <Link href="#" className="work-popup">
                <div className="portfolio-box">
                  {/* <!-- Image --> */}
                  <Image src={work1} alt="" data-rjs="2" />
                  {/* <!-- Category --> */}
            ...
            <div className="col-md-6 col-xl-6 portfolio-item category-2">
              <Link href="/singleproject">
                <div className="portfolio-box">
                  {/* <!-- Image --> */}
                  <Image src={work2} alt="" data-rjs="2" />
                  {/* <!-- Category --> */}
            ...
            <div className="col-md-6 col-xl-6 portfolio-item category-2">
              <Link
                ...
                <div className="portfolio-box">
                  {/* <!-- Image --> */}
                  <Image src={work3} alt="" data-rjs="2" />
                  {/* <!-- Category --> */}
            ...
            <div className="col-md-6 col-xl-6 portfolio-item category-1">
              <Link
                ...
                <div className="portfolio-box">
                  {/* <!-- Image --> */}
                  <Image src={work4} alt="" data-rjs="2" />
                  {/* <!-- Category --> */}
                  <span className="portfolio-category">Branding</span>
                  {/* <!-- Caption --> */}
                  <div className="portfolio-caption">
            ...
            <div className="col-md-6 col-xl-6 portfolio-item category-2">
              <Link
                ...
                <div className="portfolio-box">
                  {/* <!-- Image --> */}
                  <Image src={work5} alt="" data-rjs="2" />
                  {/* <!-- Category --> */}
                  <span className="portfolio-category">Mockup</span>
                  {/* <!-- Caption --> */}
                  <div className="portfolio-caption">
            ...
            <div className="col-md-6 col-xl-6 portfolio-item category-2">
              <Link
                ...
                <div className="portfolio-box">
                  {/* <!-- Image --> */}
                  <Image src={work6} alt="" data-rjs="2" />
                  {/* <!-- Category --> */}
