        ...
        <div className="row">
          ...
          <div className="col-lg-8 col-sm-12">
            <div className="about-content-part wow fadeInUp delay-0-2s">
              <p>
                I’m <strong>Sangram Patra</strong>, a React-focused software
                developer with 3+ years of experience building performant,
                accessible web applications. I specialize in{" "}
                <strong>React, Next.js, TypeScript</strong>, and modern frontend
                tooling, with a strong foundation in UI/UX and responsive
                design. I love turning ideas into reliable, scalable products.
              </p>
            </div>
